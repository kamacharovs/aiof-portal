                    ...
                    <Grid item xs={2}>
                        ...
                        <Grid item xs={12}>
                            <AiofPaper elevation={3}>
                                <h5>{props.currentUser.lastName + ", " + props.currentUser.firstName}</h5>
                                <hr className={classes.hr} />
                                <p>
                                    Profile page is helpful to view your overall general information such as name, gender, etc.
                                    Additionally, there is more useful to {props.appName} information to help us create more tailored 
                                    decisions and better analytics
                                </p>
                            </AiofPaper>
                        </Grid>
